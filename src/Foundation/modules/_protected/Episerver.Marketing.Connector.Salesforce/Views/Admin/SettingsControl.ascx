...
<fieldset>
    ...
    <div class="epi-size20">
        ...
        <div>
         ...
         <fieldset>
              <legend><span ID="restConfigDescription" runat="server"></span></legend>
            <div>
                <asp:Label runat="server" ID="lblConsumerKey" AssociatedControlID="uxConsumerKey"></asp:Label>
                <asp:TextBox runat="server" ID="uxConsumerKey"></asp:TextBox>
            </div>
            <div>
                <asp:Label runat="server" ID="lblConsumerSecret" AssociatedControlID="uxConsumerSecret"></asp:Label>
                <asp:TextBox runat="server" ID="uxConsumerSecret"></asp:TextBox>
            </div>
              <div>
                <asp:Label runat="server" ID="lblAsyncMode" AssociatedControlID="uxAsyncMode"></asp:Label>
                <asp:CheckBox ID="uxAsyncMode" runat="server" />
            </div>
        </fieldset>
